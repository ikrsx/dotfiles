...
------------------------------
vim.opt.autocomplete = true                     -- Enable built-in auto-completion.
vim.opt.complete:append('o')                    -- Show auto-complete window on typing.
vim.opt.completeopt = { 'menuone', 'noselect' } -- Configure completion type.
vim.opt.pumborder = 'rounded'                   -- Set rounded border for the completion suggestion.
